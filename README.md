...
This is the raw data from NASDAQ list.  It is not a simple list of ticker symbols and contains full company name, ticker, last sale, net change, %change, volume, MC, country, IPO year, industry, sector and the URL.
